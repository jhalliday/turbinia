...
public class ExecutionTracer {
    ...
    @BMRule(name = "trace_force_0",
            ...
            condition = "io.turbinia.ExecutionTracer.INSTANCE != null",
            action = "io.turbinia.ExecutionTracer.INSTANCE.force();")
    public void force() {
        logger.debug("force()");
    ...
    @BMRule(name = "trace_force_1",
            ...
            condition = "io.turbinia.ExecutionTracer.INSTANCE != null",
            action = "io.turbinia.ExecutionTracer.INSTANCE.force($1, $2);")
    ...
    @BMRule(name = "trace_writebackMemory_0",
            ...
            condition = "io.turbinia.ExecutionTracer.INSTANCE != null",
            action = "io.turbinia.ExecutionTracer.INSTANCE.writebackMemory($1,$2);")
    ...
    @BMRule(name = "trace_writebackMemory_1",
            ...
            condition = "io.turbinia.ExecutionTracer.INSTANCE != null",
            action = "io.turbinia.ExecutionTracer.INSTANCE.writebackMemory((Long)$@[1]);")
    ...
    @BMRule(name = "trace_putShort_0",
            ...
            condition = "io.turbinia.ExecutionTracer.INSTANCE != null",
            action = "io.turbinia.ExecutionTracer.INSTANCE.putShort($1, $2);")
    ...
    @BMRule(name = "trace_putInt_0",
            ...
            condition = "io.turbinia.ExecutionTracer.INSTANCE != null",
            action = "io.turbinia.ExecutionTracer.INSTANCE.putInt($this, $1, $2);")
    ...
    @BMRule(name = "trace_putLong_0",
            ...
            condition = "io.turbinia.ExecutionTracer.INSTANCE != null",
            action = "io.turbinia.ExecutionTracer.INSTANCE.putLong($1, $2);")
    ...
    @BMRule(name = "trace_putByte_0",
            ...
            condition = "io.turbinia.ExecutionTracer.INSTANCE != null",
            action = "io.turbinia.ExecutionTracer.INSTANCE.putByte($1, $2);")
    ...
    @BMRule(name = "trace_copyMemory_0",
            ...
            condition = "io.turbinia.ExecutionTracer.INSTANCE != null",
            action = "io.turbinia.ExecutionTracer.INSTANCE.copyMemory($1, $2, $3);")
    ...
    @BMRule(name = "trace_copyMemory_1",
            ...
            condition = "io.turbinia.ExecutionTracer.INSTANCE != null",
            action = "io.turbinia.ExecutionTracer.INSTANCE.copyMemory($1, $2, $3, $4, $5);")
